        ...
        ScrollView {
            VStack(spacing: 0) {
                VStack(spacing: 10) {
                    ...
                    Text(ContentStore.shared.uiString("stations.title", "The Way of the Cross"))
                        .appFont(.caption)
                        .italic()
        ...
        VStack(spacing: 0) {
            ScrollView {
                VStack(alignment: .center, spacing: 18) {
                    Text(ContentStore.shared.uiString("stations.progress", "Státio {0}  ·  {1} of 14").replacingOccurrences(of: "{0}", with: "\(station.station)").replacingOccurrences(of: "{1}", with: "\(index + 1)"))
                        .smallLabel(color: Color.goldLeaf)
                        .padding(.top, 12)
                    Text(station.station)
                        .appFont(.scaledSystem(96, weight: .semibold, design: .serif))
                        .italic()
        ...
        VStack(alignment: .leading, spacing: 8) {
            VStack(alignment: .leading, spacing: 2) {
                Text("℣. Adorámus te, Christe, et benedícimus tibi.")
                    .appFont(.bodyIt)
                    .foregroundStyle(Color.ivory)
                Text(ContentStore.shared.uiString("stations.adoramus", "We adore Thee, O Christ, and we bless Thee."))
                    .appFont(.captionSm)
                    .italic()
                    .foregroundStyle(Color.muted)
            }
            VStack(alignment: .leading, spacing: 2) {
                Text("℟. Quia per sanctam Crucem tuam redemísti mundum.")
                    .appFont(.bodyIt)
                    .foregroundStyle(Color.ivory)
                Text(ContentStore.shared.uiString("stations.quia", "Because by Thy holy Cross Thou hast redeemed the world."))
                    .appFont(.captionSm)
                    .italic()
                    .foregroundStyle(Color.muted)
            }
    ...
    private var navBar: some View {
        HStack(spacing: 18) {
            Button {
                ...
                Text("‹")
                    .appFont(.scaledSystem(22, design: .serif))
                    .foregroundStyle(Color.goldLeaf)
