            ...
            item {
                ...
                SettingsSectionFooter(
                    text = ContentStore.uiString("settings.vernacular.footer",
                        "Español covers the prayers, the Marian antiphons, the complete Ordinary of the Mass, the feast names of the calendar, the Office hour introductions, and a growing set of seasonal Mass propers; everything not yet covered falls back to English."),
                )
            }
